...
public final class MoMath {
    ...
    public static final QueryStruct LIBRARY = new QueryStruct(new HashMap<String, Function<MoParams, Object>>(){
        {
            ...
            put("hermite_blend", params -> hermiteBlend(params.getDouble(0)));
            put("inverse_lerp", params -> inverseLerp(params.getDouble(0), params.getDouble(1), params.getDouble(2)));
            ...
            put("lerprotate", params -> lerpRotate(params.getDouble(0), params.getDouble(1), params.getDouble(2)));
            put("min_angle", params -> minAngle(params.getDouble(0)));
            ...
            put("trunc", params -> (double) (long) params.getDouble(0));
    ...
    public static double hermiteBlend(double t) {
        // Hermite basis function 3t^2 - 2t^3 (spec). Best behaved in [0, 1].
