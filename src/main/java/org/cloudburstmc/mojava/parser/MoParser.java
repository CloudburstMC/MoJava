...
import org.cloudburstmc.mojava.parser.parselet.*;
...
public final class MoParser {
    ...
    static {
        ...
        infixParselets.put(TokenType.EQUALS, new GenericBinaryOpParselet(Precedence.EQUALITY));
        infixParselets.put(TokenType.NOT_EQUALS, new GenericBinaryOpParselet(Precedence.EQUALITY));
    ...
    public MoParser(TokenIterator iterator, String originalString) {
    ...
    public String fixNameShortcut(String name) {
        ...
        switch (splits[0]) {
            case "q" -> splits[0] = MoEnvironment.QUERY;
            case "v" -> splits[0] = MoEnvironment.VARIABLE;
            case "t" -> splits[0] = MoEnvironment.TEMP;
            case "c" -> splits[0] = MoEnvironment.CONTEXT;
        }
